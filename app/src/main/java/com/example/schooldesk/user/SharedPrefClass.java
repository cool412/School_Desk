...
public class SharedPrefClass {
    ...
    public void writeAccountType(String accountType) {
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString(context.getString(R.string.pref_account_type), accountType);
        editor.apply();
    }
    ...
    public String readAccountType() {
        return sharedPreferences.getString(context.getString(R.string.pref_account_type), "");
    }
}
